...
if ( ! class_exists( 'CPFM_Review' ) ) {
	...
	final class CPFM_Review {
		...
		private static function cpfm_quiet_period_active( $config ) {
			...
			// deactivated (Cool Timeline on a site that now only runs Event
			// Countdown) must not silence everyone else for the rest of the
			// fortnight — nothing is on screen to "use" that slot.
